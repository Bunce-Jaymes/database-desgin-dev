...
WHERE   m.member_id = c.contact_id;
...
WHERE   a.address_id = s.street_address_id;
...
,    su.created_by
,    su2.system_user_id
FROM system_user su INNER JOIN system_user su2
ON su.created_by = su2.system_user_id;
...
,    su2.system_user_id
FROM system_user su INNER JOIN system_user su2
ON su.last_updated_by = su2.system_user_id;
...
ON su.last_updated_by = su3.system_user_id;

-- --------------------------------------------------
--  Step 4: Write three table joins.
-- --------------------------------------------------
COL rental_id        FORMAT 999999  HEADING "Rental Table|------------|Rental ID #"
COL rental_item_id   FORMAT 999999  HEADING "Rental Item Table|------------|Rental ID #"
COL rental_item_id2   FORMAT 999999  HEADING "Rental Item Table|------------|Item ID #"
...
SELECT
    r.rental_id
,   ri.rental_item_id 
,   ri2.rental_item_id AS rental_item_id2
,   i.item_id
FROM rental r
INNER JOIN rental_item ri
ON r.rental_id = ri.rental_item_id
INNER JOIN rental_item ri2
ON ri.rental_item_id = ri2.rental_item_id
INNER JOIN item i
ON ri2.rental_item_id = i.item_id;
